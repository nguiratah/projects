function[] = nofeedbackgenerationplot2(lambda, TD, D, N,  G, n_samples, K)
G =1;
n_samples =25;
N  = 25;
%L2 = 29;
...
title(['K/coding window size normalized = f(coding window size) for TD =' int2str(TD)]);
xlabel('coding window size');
ylabel('(*K/coding window)');
%% second loop :
% s =  10;
