function[] = nofeedbackgenerationplot2012(lambda, TD, D, N,  G, n_samples, K)
G = 400;
n_samples =100;
N  = 100;
%L2 = 29;
...
% %    x1(i) = nofeedbackgenerations(1, TD, D, N, 0.25, G, s, K(i))/(K(i)*10);
% %    y1(i) = nofeedbackgenerations(1, TD, D, N, 0.5, G, s, K(i))/(K(i)*10);
% %    j1(i) = nofeedbackgenerations(1, TD, D, N, 0.75, G, s, K(i)/(K(i)*10))
% end
