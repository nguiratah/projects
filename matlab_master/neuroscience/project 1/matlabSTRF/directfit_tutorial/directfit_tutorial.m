...
%%%%
%%%% EPFL
%%%% Class "Statistical Neuroscience"
%%%% Fall 2012 (taught by Prof. M.C. Gastpar)
%%%% 
%%%%   "STRF Tutorial session"
%%%%     Tuesday, September 25, 2012
%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%
%%%% This code is courtesy of Prof. F.E. Theunissen,
%%%% University of California, Berkeley
%%%%   http://psychology.berkeley.edu/people/frederic-theunissen
%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% stimuli.
datasets = find_datasets(cellDir, stimsDir, 'songrip');
