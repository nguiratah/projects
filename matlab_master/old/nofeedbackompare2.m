function[] = nofeedbackompare2(lambda, TD, D, N,  G, n_samples, K)
G =1000;
n_samples =25;
N  = 25;
%L2 = 29;
...
for i = 1 : n_samples
  ...
  for r = 1 : g*s(i)
  K(r) =r;
  a(r, i) = nofeedbackgenerations(lambda, TD, D, N, 0.75, G, s(i), K(r));%/(H*floor(K(r)*N/s(i)));
  b(r, i) = nofeedbacksliding(lambda, TD, D, N, 0.75, G, s(i), K(r), m);%/(H*floor(K(r)*N/s(i)));
...
plot(s,a1,s,b1);
legend('GB Pe =0.75, lambda = 25', 'Sliding window Pe =0.75, lambda =25')
